...
class RemoteDataSource private constructor ( private val netWorkService: NetWorkService ) :
    ...
    override suspend fun getTodayForecast(lat :Double, lon:Double, language: String): Flow<CurrentDayWeatherResponce> {
        return flow {
    ...
    override suspend fun getAllFiveDaysForecast (lat :Double, lon:Double, language: String):Flow<ForecastResponse>
    {
        return flow {
